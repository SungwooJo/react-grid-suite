...
import {perc, setTopLeft, setTransform} from './utils/GridUtils';
import {generateInnerGridView} from './';

import type {CorePosition, Position} from './utils/GridUtils';



const noop = () => {};
const tempItems = [0, 1].map(function (i, key, list) {
  return {i: i.toString(), x: 0, y: 0, w: 1, h: 1};
});
...
export default class Placeholder extends React.Component {
  ...
  createStyle(pos: Position): {[key: string]: ?string} {
    const {usePercentages, containerWidth, useCSSTransforms, innerGridPos} = this.props;
    ...
    // top,left (slow)
      ...
      pos.top += innerGridPos.top;
      pos.left += innerGridPos.left;
  ...
  render(): React.Element {
    const {x, y, w, h, i, isDraggable, isResizable, useCSSTransforms, isInnerGrid, innerGriditems, innerGridLayout, containerWidth, margin} = this.props;
...
Placeholder.propTypes = {
  ...
  // Props by swjo
  isInnerGrid: PropTypes.bool,
  innerGridLayout: PropTypes.array,
